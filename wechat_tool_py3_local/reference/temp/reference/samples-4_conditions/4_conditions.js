...
var flow_path = '/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-4_conditions';

casper.start('https://www.google.com.sg', function() {
techo('https://www.google.com.sg' + ' - ' + this.getTitle() + '\n');});
...
casper.then(function() {if (((menu.indexOf("fruits")>-1)))
{ // start of code block

casper.then(function() {this.echo("Menu contains fruits. (condition and action in natural language)");});
...
casper.then(function() {this.echo("Menu contains fruits. (condition in JavaScript, action in natural language)");});

} // end of code block
});

casper.then(function() {if ((menu == "salads fruits sandwiches"))
{ // start of code block

casper.then(function() {this.echo("This is perfect.");});

} // end of code block
});

casper.then(function() {if ((menu != "salads fruits sandwiches") && ((menu.indexOf("salads")>-1)))
{ // start of code block

casper.then(function() {this.echo("This is not too bad.");});

} // end of code block
});

// combination of different conditions as a single condition to check
casper.then(function() {if (((menu.indexOf("fruits")>-1)) && ((menu.indexOf("meat")<0)))
{ // start of code block

casper.then(function() {this.echo("Menu contains fruits and no meat.");});

} // end of code block
});

casper.then(function() {if (((menu.indexOf("cheese")>-1)) || ((menu.indexOf("fish")>-1)) || ((menu.indexOf("meat")>-1)))
{ // start of code block

casper.then(function() {this.echo("Menu is not vegan-friendly.");});
...
casper.then(function() {if ((cupcakes < 6))
{ // start of code block

casper.then(function() {this.echo("Time to restock cupcakes.");});

} // end of code block
});

casper.then(function() {if ((cupcakes >= 12))
{ // start of code block

casper.then(function() {this.echo("That is a lot of cupcakes on the table.");});

} // end of code block
});

casper.then(function() {if ((cupcakes >= 24))
{ // start of code block

casper.then(function() {this.echo("That is really a lot of cupcakes on the table.");});
...
casper.then(function() {this.echo("Just nice to fit in a box.");});

} // end of code block
});

casper.then(function() {if ((cupcakes > 1) && (cupcakes < 3))
{ // start of code block

casper.then(function() {this.echo("Just nice for you and me.");});
...
casper.then(function() {for (Product_ID=2; Product_ID<=5; Product_ID++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][Product_ID]';});
(function (Product_ID) { // start of IIFE pattern
{ // start of code block

casper.then(function() {this.echo("Current Product ID is - "+Product_ID);});

} // end of code block
})(Product_ID); // end of IIFE pattern, with dummy marker for break step
casper.then(function() {for_loop_signal = '[BREAK_SIGNAL][Product_ID]';});}});
...
casper.then(function() {for (n=1; n<=infinity; n++)
{casper.then(function() {for_loop_signal = '[CONTINUE_SIGNAL][n]';});
(function (n) { // start of IIFE pattern
{ // start of code block

casper.then(function() {this.echo(n);});

casper.then(function() {if ((n >= 5))
{ // start of code block

casper.then(function() { // start of JS code
casper.bypass(teleport_distance('[BREAK_SIGNAL][n]')); return;
}); // end of JS code
...
casper.then(function() {if ((n == 3))
{ // start of code block

casper.then(function() { // start of JS code
casper.bypass(teleport_distance('[CONTINUE_SIGNAL][n]')); return;
}); // end of JS code
