...
var flow_path = '/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-6_datatables';
...
casper.then(function() {{techo('read fullname to fullname');
casper.waitFor(function check() {return check_tx('fullname');},
function then() {fullname = this.fetchText(tx('fullname')).trim();},
function timeout() {this.echo('ERROR - cannot find fullname').exit();});}});

casper.then(function() {{techo('read username to username');
casper.waitFor(function check() {return check_tx('username');},
function then() {username = this.fetchText(tx('username')).trim();},
function timeout() {this.echo('ERROR - cannot find username').exit();});}});

// read User Email to variable if information exists
casper.then(function() {if ((present('//*[@itemprop="email"]')))
{ // start of code block

casper.then(function() {{techo('read //*[@itemprop="email"] to email');
casper.waitFor(function check() {return check_tx('//*[@itemprop="email"]');},
function then() {email = this.fetchText(tx('//*[@itemprop="email"]')).trim();},
function timeout() {this.echo('ERROR - cannot find //*[@itemprop="email"]').exit();});}});

} // end of code block
});

// read User Website to variable if information exists
casper.then(function() {if ((present('//*[@itemprop="url"]')))
{ // start of code block

casper.then(function() {{techo('read //*[@itemprop="url"] to url');
casper.waitFor(function check() {return check_tx('//*[@itemprop="url"]');},
function then() {url = this.fetchText(tx('//*[@itemprop="url"]')).trim();},
function timeout() {this.echo('ERROR - cannot find //*[@itemprop="url"]').exit();});}});

} // end of code block
});

// read User Location to variable if information exists
casper.then(function() {if ((present('//*[@itemprop="homeLocation"]')))
{ // start of code block

casper.then(function() {{techo('read //*[@itemprop="homeLocation"] to country');
casper.waitFor(function check() {return check_tx('//*[@itemprop="homeLocation"]');},
function then() {country = this.fetchText(tx('//*[@itemprop="homeLocation"]')).trim();},
function timeout() {this.echo('ERROR - cannot find //*[@itemprop="homeLocation"]').exit();});}});

} // end of code block
});

// read User Biography to variable if information exists
casper.then(function() {if ((present('user-profile-bio')))
{ // start of code block

casper.then(function() {{techo('read user-profile-bio to bio');
casper.waitFor(function check() {return check_tx('user-profile-bio');},
function then() {bio = this.fetchText(tx('user-profile-bio')).trim();},
function timeout() {this.echo('ERROR - cannot find user-profile-bio').exit();});}});

} // end of code block
});

// show the information retrieved to screen and log file
casper.then(function() {this.echo(fullname+","+username+","+email+","+url+","+country+","+bio);});
