...
var flow_path = '/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-c_chineseflow';
...
casper.then(function() {{techo('type search-box as github sam gu');
casper.waitFor(function check() {return check_tx('search-box');},
function then() {this.sendKeys(tx('search-box'),'github sam gu');},
...
casper.then(function() {if ((number >= 1))
{ // start of code block
...
casper.then(function() {this.echo('~ changing output language to english ~');});

casper.then(function() { // start of JS code
tagui_language = 'english'
}); // end of JS code

casper.then(function() {for (n=1; n<=3; n++)
...
casper.then(function() {if (((text.indexOf('bcd')>-1)))
{ // start of code block

casper.then(function() {{techo('snap page to results.png');
this.capture('/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-c_chineseflow/results.png');}});
...
casper.then(function() {this.echo('~ changing output language to french ~');});
...
this.capture('/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-c_chineseflow/duckduckgo.png');}});

casper.then(function() {this.echo('');});

casper.then(function() {this.echo('~ changing output language to japanese ~');});
