...
var flow_path = '/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-S-IPA-ws-2.3-A-yahoo';

casper.start('https://ca.yahoo.com', function() {
techo('https://ca.yahoo.com' + ' - ' + this.getTitle() + '\n');});
...
casper.then(function() {this.echo('NOTE - this sample may not work for EU users due to website changes for GDPR');});

casper.then(function() {this.echo('EU users may have to modify script to first click on announcement OK button');});
...
casper.then(function() {{techo('type search-box as github');
casper.waitFor(function check() {return check_tx('search-box');},
function then() {this.sendKeys(tx('search-box'),'github');},
function timeout() {this.echo('ERROR - cannot find search-box').exit();});}});

casper.then(function() {{techo('show search-box');
casper.waitFor(function check() {return check_tx('search-box');},
function then() {this.echo(this.fetchText(tx('search-box')).trim());},
function timeout() {this.echo('ERROR - cannot find search-box').exit();});}});
...
casper.then(function() {{techo('click search-button');
casper.waitFor(function check() {return check_tx('search-button');},
function then() {this.click(tx('search-button'));},
function timeout() {this.echo('ERROR - cannot find search-button').exit();});}});
...
casper.then(function() {techo('wait 6.6');});
casper.wait(6600, function() {});
...
casper.then(function() {{techo('snap page');
this.capture(snap_image());}});

casper.then(function() {{techo('snap logo');
casper.waitFor(function check() {return check_tx('logo');},
function then() {this.captureSelector(snap_image(),tx('logo'));},
function timeout() {this.echo('ERROR - cannot find logo').exit();});}});
...
this.capture('/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-S-IPA-ws-2.3-A-yahoo/results.png');}});

casper.then(function() {{techo('snap logo to logo.png');
casper.waitFor(function check() {return check_tx('logo');},
function then() {this.captureSelector('/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-S-IPA-ws-2.3-A-yahoo/logo.png',tx('logo'));},
function timeout() {this.echo('ERROR - cannot find logo').exit();});}});

// to go to another URL from your flow, simply provide the URL
casper.thenOpen('https://duckduckgo.com', function() {
techo('https://duckduckgo.com' + ' - ' + this.getTitle());});

// and then continue the automation flow from there
casper.then(function() {{techo('type search_form_input_homepage as The search engine that doesn\'t track you.');
casper.waitFor(function check() {return check_tx('search_form_input_homepage');},
function then() {this.sendKeys(tx('search_form_input_homepage'),'The search engine that doesn\'t track you.');},
function timeout() {this.echo('ERROR - cannot find search_form_input_homepage').exit();});}});

casper.then(function() {{techo('snap page to duckduckgo.png');
this.capture('/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-S-IPA-ws-2.3-A-yahoo/duckduckgo.png');}});

casper.then(function() {techo('wait 4.4 seconds');});
casper.wait(4400, function() {});
