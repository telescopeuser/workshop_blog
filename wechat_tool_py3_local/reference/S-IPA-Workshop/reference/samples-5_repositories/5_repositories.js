...
var flow_path = '/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-5_repositories';

casper.start('https://vk.com/kensoh', function() {
techo('https://vk.com/kensoh' + ' - ' + this.getTitle() + '\n');});
...
casper.then(function() {{techo('type quick_email as mickey_mouse@disney.com');
casper.waitFor(function check() {return check_tx('quick_email');},
function then() {this.sendKeys(tx('quick_email'),'mickey_mouse@disney.com');},
function timeout() {this.echo('ERROR - cannot find quick_email').exit();});}});

casper.then(function() {{techo('type quick_pass as iloveminnie4eva');
casper.waitFor(function check() {return check_tx('quick_pass');},
function then() {this.sendKeys(tx('quick_pass'),'iloveminnie4eva');},
function timeout() {this.echo('ERROR - cannot find quick_pass').exit();});}});
...
casper.then(function() {{techo('hover Show full information');
casper.waitFor(function check() {return check_tx('Show full information');},
function then() {this.mouse.move(tx('Show full information'));},
function timeout() {this.echo('ERROR - cannot find Show full information').exit();});}});

casper.then(function() {techo('wait 2.5');});
casper.wait(2500, function() {});

casper.then(function() {{techo('click Show full information');
casper.waitFor(function check() {return check_tx('Show full information');},
function then() {this.click(tx('Show full information'));},
function timeout() {this.echo('ERROR - cannot find Show full information').exit();});}});
...
casper.then(function() {{techo('snap page to vk.png');
this.capture('/home/iss-user/iss-vm-program/is-intelligent-process-automation/TagUI/src/samples-5_repositories/vk.png');}});

// hover and click on the facebook link, adding wait to see effect of action
casper.then(function() {{techo('hover //*[@id="profile_full"]//a');
casper.waitFor(function check() {return check_tx('//*[@id="profile_full"]//a');},
function then() {this.mouse.move(tx('//*[@id="profile_full"]//a'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="profile_full"]//a').exit();});}});

casper.then(function() {techo('wait 2.5');});
casper.wait(2500, function() {});

casper.then(function() {{techo('click //*[@id="profile_full"]//a');
casper.waitFor(function check() {return check_tx('//*[@id="profile_full"]//a');},
function then() {this.click(tx('//*[@id="profile_full"]//a'));},
function timeout() {this.echo('ERROR - cannot find //*[@id="profile_full"]//a').exit();});}});
