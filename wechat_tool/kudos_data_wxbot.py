...
import HTMLParser
# Kudos Data: TO display image in Jupyter Notebook inside a VM
...
def show_image(file_path):
    ...
    """
    print('QR image file_path is: %s' % file_path)
...
class WXBot:
    ...
    def qr_auth(self):
        try:
            ...
            print '[ERROR] Web WeChat QR log-in authentication failed --> %s'%(e)
